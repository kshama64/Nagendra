...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 py-10 px-5 md:px-10 mt-24">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start mb-12">
        ...
        <div className="w-full md:w-1/2">
          <h1 className="text-3xl md:text-3xl font-bold text-gray-800 mb-6 text-center">Our Company</h1>
          <p className="text-lg md:text-xl text-gray-600 mb-6 leading-relaxed">
            At GiftDgift, we believe in the power of giving. Our innovative payment gateway is designed to make the act of gifting as easy as a single click.
            Whether you're looking to collect funds for a group gift, organize a charity event, or simply send a personalized present, our platform is here to
            make the entire process smooth, secure, and hassle-free. With GiftDgift, you can bring joy to your loved ones and make a difference in the world, 
